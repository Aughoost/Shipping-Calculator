...

{
...

    {
        ...
        if (isset($postData['search'])) {
            ...
            // $userlist = $userlist = $Users->select('Code,Weight')
            ...
            $red = "select Code,Weight from calculator where Code like '%$term%' order by Code LIMIT 3";

            $userlist = mysqli_query( $conn, $red);


            // $countAllSearchProducts = count($userlist);



            // if($countAllSearchProducts = 0)
            ...
            if (!$userlist) {
                ...
                //    $userlist = $userlist = $Users->select('Code,Name,Weight')
                ...
                //     ->findAll(5);
                    ...
                    $red = "select Code,Weight,Name from calculator where Code like '%$term%' order by Code LIMIT 3";
...

    {
        ...
        if (trim($code) != "" || trim($city) !="" ) {
            ...
            $userlist = $Users->select('City,Island,PostCode')
            ...
            //     $userlist1 = $Users->select('City,Island,PostCode')
